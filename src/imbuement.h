...
struct Imbuement : std::enable_shared_from_this<Imbuement> {
    Imbuement() = default;
    Imbuement(ImbuementType imbuetype, uint32_t value, uint32_t duration, ImbuementDecayType decayType = ImbuementDecayType::IMBUEMENT_DECAY_NONE) 
        : imbuetype{ imbuetype }, value{ value }, duration{ duration }, decaytype{ decayType } {};
